        ...
        headers: [
          ...
          // Content Security Policy - RESTORED WITH PROPER S3 DOMAINS
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://api.openai.com https://api.edamam.com https://*.supabase.co wss://*.supabase.co https://*.sentry.io https://*.s3.amazonaws.com https://workout-media.s3.ca-central-1.amazonaws.com https://d3rm7f2fy3hn6r.cloudfront.net workout-media.s3.ca-central-1.amazonaws.com https://api.stripe.com https://smtp.resend.com https://api.resend.com",
